...
\title{\textbf{Lecture 6: AC Optimal Power Flow}}
\author{
%Your name\\
...
\textit{Hint: It is recommended to follow the} \href{https://aleks-g.github.io/integrated-energy-grids/intro-pypsa.html#}{PyPSA tutorial} \textit{before trying this problem.}
