...
\title{\textbf{Lecture 5: DC Optimal Power Flow}}
\author{
%Your name\\
...
This is a continuation of Problem 4.2 from Lecture 4.
...
\textit{Hint 1: Remember the relations between power injection $p_i$ in every node and power flows $p_l$ presented in Lecture 5.}
...
\item[b)] Assuming the power injection pattern described in Problem 5.1 determine the flows in the lines of the network. 
...
\begin{problem}{5.3}
This is a continuation of Problem 4.3 from Lecture 4.
Using the Python package \href{https://networkx.org/}{networkX}.

\begin{itemize}
\item[a)] Assuming that the reactance in the links is $x_l$=1, calculate the Power Transfer Distribution Factor (PTDF) matrix.

\item[b)] Assuming the power injection pattern described in Problem 5.1 determine the power flows in the lines of the network and plot them.
...
\begin{problem}{5.4}
This is a continuation of Problem 4.4 from Lecture 4. For the synchronous zone corresponding to Scandinavia:
