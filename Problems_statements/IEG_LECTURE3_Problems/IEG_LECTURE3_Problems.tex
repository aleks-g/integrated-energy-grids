...
\title{\textbf{Lecture 3: Joint capacity and dispatch optimisation}}
\author{
%Your name\\
...
\begin{problem}{3.2}
	Optimise the model described in Problem 3.1 without the CCGT generator (but with the battery). Calculate the revenues collected by the OCGT plant throughout the year and show that their sum is equal to its costs.
